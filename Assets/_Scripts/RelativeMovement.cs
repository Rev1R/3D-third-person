...
[RequireComponent(typeof(CharacterController))]                //окружающие строки показывают контекст размещения метода RequireComponent()
public class RelativeMovement : MonoBehaviour
{
	[SerializeField] private Transform target;          //вывести в инспектор
	...
	{
		_contact = hit;
		Rigidbody body = hit.collider.attachedRigidbody;  //проверяем, есть ли у участвующего в столкновении обьекта компонент Rigidbody
